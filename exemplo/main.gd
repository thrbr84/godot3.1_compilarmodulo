...
func _on_admob_ad_loaded():
	...
	get_node("CanvasLayer/Node2D/BtnBanner").set_disabled(false)
...
func _on_interstitial_close():
	...
	get_node("CanvasLayer/Node2D/BtnInterstitial").set_disabled(true)

func _on_rewarded_video_ad_loaded():
	print("Rewarded loaded success")
	get_node("CanvasLayer/Node2D/BtnRewardedVideo").set_disabled(false)
	
func _on_rewarded_video_ad_closed():
	print("Rewarded closed")
	get_node("CanvasLayer/Node2D/BtnRewardedVideo").set_disabled(true)
	loadRewardedVideo()
